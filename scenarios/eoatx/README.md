...
git clone https://github.com/godzillaba/spamoor/ -b funding && cd spamoor

sudo sysctl -w net.ipv4.tcp_tw_reuse=1 
sudo sysctl -w net.ipv4.ip_local_port_range="1024 65535"

# fund wallets:
make && ./bin/spamoor eoatx --privkey $PRIVATE_KEY --rpchost $RPC_URL --funding-gas-limit 1000000000000 --funding-gas-price 200000 --refill-amount-wei 20000020000000000 --refill-balance-wei 10000020000000000

# execute test:
git checkout eoatx-opt 
make && ./bin/spamoor eoatx --privkey $PRIVATE_KEY --rpchost $RPC_URL -t 1280 --slot-duration 250ms --basefee-wei=110000 --tipfee-wei=1 --max-wallets 100000 --refill-amount-wei 20000020000000000 --refill-balance-wei 1 --max-pending 8000 --gaslimit 100000000000 --skip-receipts --disable-block-processing
```
